...
#
# python /path/to/pyinstaller.py bag_bbox.1folder.spec
#
# The resulting .exe file is placed in the dist/bag_bbox folder.
...
a = Analysis([os.path.abspath(os.path.join('hydroffice', 'bag', 'tools', 'bag_bbox.py'))],
             pathex=[],
             hiddenimports=[],
