...
#
# python /path/to/pyinstaller.py bag_uncertainty.1folder.spec
#
# The resulting .exe file is placed in the dist/bag_uncertainty folder.
...
a = Analysis([os.path.abspath(os.path.join('hydroffice', 'bag', 'tools', 'bag_uncertainty.py'))],
             pathex=[],
             hiddenimports=[],
