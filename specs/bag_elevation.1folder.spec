...
#
# python /path/to/pyinstaller.py bag_elevation.1folder.spec
#
# The resulting .exe file is placed in the dist/bag_elevation folder.
...
a = Analysis([os.path.abspath(os.path.join('hydroffice', 'bag', 'tools', 'bag_elevation.py'))],
             pathex=[],
             hiddenimports=[],
